...
var connectionString = 'HostName=gmdelftiotpracticum2020.azure-devices.net;DeviceId=device-student-10-device-4;SharedAccessKey=NvMUY3sZrnUbZvntbiHEd+ZSnKPY4kqbEQyKissezcU=';
...
var intervalLoop = 0
 ...
 function onLamp(req,res){
  ...
  if (status == status_new) {
      ...
      console.log('Lamp 3 is AL aan ')

  } else {

      status_new = status

      console.log('Lamp 3 is NU aan')
  }
